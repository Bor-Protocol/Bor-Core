...
export const webSearch: Action = {
    ...
    handler: async (
        ...
        aiKhwarizmiLogger.log("Composing state for message:", message);
        state = (await runtime.composeState(message)) as State;
        const userId = runtime.agentId;
        aiKhwarizmiLogger.log("User ID:", userId);

        const webSearchPrompt = message.content.text;
        aiKhwarizmiLogger.log("web search prompt received:", webSearchPrompt);
        ...
        if (searchResponse && searchResponse.results.length) {
            ...
            aiKhwarizmiLogger.error("search failed or returned no data.");
        }
    },
    examples: [
        [
